import unittest
import numpy as np
from src.data_io.builders.model_builders.features.aggregate.aggregate_feature_set_entry_builder import AggregateFeatureSetEntryBuilder
from src.data_io.formats.hdf5.hdf5_group import HDF5Group
from src.data_model.features.aggregate.aggregate_feature_set_entry import AggregateFeatureSetEntry

class TestAggregateFeatureBuilder(unittest.TestCase):
    def setUp(self):
